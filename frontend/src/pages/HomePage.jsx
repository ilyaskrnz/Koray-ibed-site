...
const HomePage = () => {
  ...
  return (
    <div data-testid="home-page" className="min-h-screen">
      ...
      {/* Featured Products */}
      <section className="py-24 md:py-32 bg-[#0f172a]/50">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div>
              ...
              <p className="text-slate-400">En çok tercih edilen modellerimiz</p>
            </div>
            <Link
              to="/urunler"
              data-testid="featured-products-see-all"
              className="flex items-center gap-2 text-[#4ecdc4] font-medium hover:gap-3 transition-all"
            >
              Tümünü Gör
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-lg font-semibold text-white group-hover:text-[#4ecdc4] transition-colors">
                        {product.name}
                      </h3>
                    </div>
                  </Link>
