...
const translations = {
  tr: {
    ...
    whyIbed: "Neden",
    guarantee: "Garanti",
    guaranteeDesc: "Ürün garantisi ile güvenli alışveriş",
    ...
    reliabilityDesc: "Ürünlerimizin arkasında duruyoruz.",
  ...
  en: {
    ...
    whyIbed: "Why",
    guarantee: "Warranty",
    guaranteeDesc: "Safe shopping with product warranty",
    ...
    reliabilityDesc: "We stand behind our products.",
  ...
  ar: {
    ...
    whyIbed: "لماذا",
    guarantee: "الضمان",
    guaranteeDesc: "تسوق آمن مع ضمان المنتج",
    ...
    reliabilityDesc: "نقف وراء منتجاتنا.",
